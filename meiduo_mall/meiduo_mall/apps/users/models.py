...
class User(AbstractUser):
    ...
    def generate_send_sms_code_token(self):
        ...
        生成发送短信验证码的token
        """
        serializer = Serializer(settings.SECRET_KEY, expires_in=constants.SEND_SMS_TOKEN_EXPIRES)
    ...
    def generate_set_password_token(self):
        ...
        生成修改密码的token
        """
        serializer = Serializer(settings.SECRET_KEY, expires_in=constants.SET_PASSWORD_TOKEN_EXPIRES)
