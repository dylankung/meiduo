...
SECRET_KEY = '(bjdfx-v1r#dyrjxi8-13nsce%5=2%+kh5kp80lzj7$!cty*xf'
...
# 生成的静态html文件保存目录
GENERATED_STATIC_HTML_FILES_DIR = '/root/meiduo_mall/front_end_pc/'


# 定时任务
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /root/logs/crontab.log')
]
# 解决crontab中文问题
